...
import * as SSD_SERVICE_ID_sd_DNXoCjln8FbFNtKj from './flows'; //_splitter_
//append_imports_end
export class master_data_apis {
    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          //appendnew_next_sd_5DKVnNny4WYemoDp
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_5DKVnNny4WYemoDp');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          //appendnew_next_sd_vx17K7CsDwEF0Gga
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_vx17K7CsDwEF0Gga');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          //appendnew_next_sd_89wNAesKtEIfTypB
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_89wNAesKtEIfTypB');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
  ...
  async getMasterData(bh, parentSpanInst) {
    ...
    try {
      ...
      await this.sd_oQyslEZ6zXzFuj9w(bh, parentSpanInst);
  ...
  async sd_oQyslEZ6zXzFuj9w(bh, parentSpanInst) {
    try {
      bh.web.res.status(200).send(bh.result);

      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_oQyslEZ6zXzFuj9w');
    }
  }
  ...
  async getProduct(bh, parentSpanInst) {
    ...
    try {
      const SSD_SERVICE_ID_sd_DNXoCjln8FbFNtKjInstance: SSD_SERVICE_ID_sd_DNXoCjln8FbFNtKj.flows =
        SSD_SERVICE_ID_sd_DNXoCjln8FbFNtKj.flows.getInstance();
      let outputVariables =
        await SSD_SERVICE_ID_sd_DNXoCjln8FbFNtKjInstance.getProducts(
          spanInst,
          bh.input.body
        );
      ...
      this.tracerService.sendData(spanInst, bh);
      await this.sd_JnOnbj3mkIulYDSr(bh, parentSpanInst);
  ...
  async sd_JnOnbj3mkIulYDSr(bh, parentSpanInst) {
    try {
      bh.web.res.status(200).send(bh.response);

      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_JnOnbj3mkIulYDSr');
    }
  }
  ...
  async getAddOn(bh, parentSpanInst) {
    ...
    try {
      ...
      this.tracerService.sendData(spanInst, bh);
      await this.sd_W1Hjdr4nIBUvcYp0(bh, parentSpanInst);
  ...
  async sd_W1Hjdr4nIBUvcYp0(bh, parentSpanInst) {
    try {
      bh.web.res.status(200).send(bh.response);

      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_W1Hjdr4nIBUvcYp0');
    }
  }
