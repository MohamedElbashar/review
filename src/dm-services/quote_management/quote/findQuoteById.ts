...
export class findQuoteById {
  ...
  private constructor(
    ...
    this.serviceName = 'findQuoteById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findQuoteById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findQuoteById');
    //appendnew_flow_findQuoteById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findQuoteById');

    this.app['post'](
      `${this.serviceBasePath}/dm/quote_management/quote/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findQuoteById_HttpIn
  }
  //   service flows_findQuoteById

  //appendnew_flow_findQuoteById_start
  ...
  //appendnew_flow_findQuoteById_Catch
}
