...
//append_imports_end
export class createOtpRegistry {
  ...
  private constructor(
    ...
    this.serviceName = 'createOtpRegistry';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createOtpRegistry(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createOtpRegistry_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createOtpRegistry');
    //appendnew_flow_createOtpRegistry_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createOtpRegistry');

    this.app['post'](
      `${this.serviceBasePath}/dm/communication/otp_registry/create`,
      cookieParser(),
    ...
    //appendnew_flow_createOtpRegistry_HttpIn
  }
  //   service flows_createOtpRegistry

  //appendnew_flow_createOtpRegistry_start
  ...
  //appendnew_flow_createOtpRegistry_Catch
}
