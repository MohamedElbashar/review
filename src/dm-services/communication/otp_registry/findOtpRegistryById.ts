...
//append_imports_end
export class findOtpRegistryById {
  ...
  private constructor(
    ...
    this.serviceName = 'findOtpRegistryById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findOtpRegistryById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findOtpRegistryById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findOtpRegistryById');
    //appendnew_flow_findOtpRegistryById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findOtpRegistryById');

    this.app['post'](
      `${this.serviceBasePath}/dm/communication/otp_registry/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findOtpRegistryById_HttpIn
  }
  //   service flows_findOtpRegistryById

  //appendnew_flow_findOtpRegistryById_start
  ...
  //appendnew_flow_findOtpRegistryById_Catch
}
