...
export class findRoleById {
  ...
  async mountTimers() {
    //appendnew_flow_findRoleById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findRoleById');
    //appendnew_flow_findRoleById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findRoleById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/role/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findRoleById_HttpIn
  }
  //   service flows_findRoleById

  //appendnew_flow_findRoleById_start
  ...
  //appendnew_flow_findRoleById_Catch
}
