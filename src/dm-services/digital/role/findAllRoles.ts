...
export class findAllRoles {
  ...
  async mountTimers() {
    //appendnew_flow_findAllRoles_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findAllRoles');
    //appendnew_flow_findAllRoles_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findAllRoles');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/role/find-all`,
      cookieParser(),
    ...
    //appendnew_flow_findAllRoles_HttpIn
  }
  //   service flows_findAllRoles

  //appendnew_flow_findAllRoles_start
  ...
  //appendnew_flow_findAllRoles_Catch
}
