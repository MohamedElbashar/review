...
export class createRole {
  ...
  async mountTimers() {
    //appendnew_flow_createRole_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createRole');
    //appendnew_flow_createRole_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createRole');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/role/create`,
      cookieParser(),
    ...
    //appendnew_flow_createRole_HttpIn
  }
  //   service flows_createRole

  //appendnew_flow_createRole_start
  ...
  //appendnew_flow_createRole_Catch
}
