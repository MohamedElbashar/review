...
export class updateAllRoles {
  ...
  private constructor(
    ...
    this.serviceName = 'updateAllRoles';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_updateAllRoles_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateAllRoles');
    //appendnew_flow_updateAllRoles_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateAllRoles');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/role/update-all`,
      cookieParser(),
    ...
    //appendnew_flow_updateAllRoles_HttpIn
  }
  //   service flows_updateAllRoles

  //appendnew_flow_updateAllRoles_start
  ...
  //appendnew_flow_updateAllRoles_Catch
}
