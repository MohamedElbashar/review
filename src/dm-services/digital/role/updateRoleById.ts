...
export class updateRoleById {
  ...
  private constructor(
    ...
    this.serviceName = 'updateRoleById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_updateRoleById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateRoleById');
    //appendnew_flow_updateRoleById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateRoleById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/role/update-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_updateRoleById_HttpIn
  }
  //   service flows_updateRoleById

  //appendnew_flow_updateRoleById_start
  ...
  //appendnew_flow_updateRoleById_Catch
}
