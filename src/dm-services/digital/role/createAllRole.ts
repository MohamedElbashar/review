...
export class createAllRole {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllRole';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_createAllRole_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllRole');
    //appendnew_flow_createAllRole_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllRole');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/role/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllRole_HttpIn
  }
  //   service flows_createAllRole

  //appendnew_flow_createAllRole_start
  ...
  //appendnew_flow_createAllRole_Catch
}
