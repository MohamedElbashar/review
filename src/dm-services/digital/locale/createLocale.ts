...
export class createLocale {
  ...
  async mountTimers() {
    //appendnew_flow_createLocale_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createLocale');
    //appendnew_flow_createLocale_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createLocale');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/locale/create`,
      cookieParser(),
    ...
    //appendnew_flow_createLocale_HttpIn
  }
  //   service flows_createLocale

  //appendnew_flow_createLocale_start
  ...
  //appendnew_flow_createLocale_Catch
}
