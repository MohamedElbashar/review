...
export class updateAllLocales {
  ...
  private constructor(
    ...
    this.serviceName = 'updateAllLocales';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_updateAllLocales_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateAllLocales');
    //appendnew_flow_updateAllLocales_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateAllLocales');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/locale/update-all`,
      cookieParser(),
    ...
    //appendnew_flow_updateAllLocales_HttpIn
  }
  //   service flows_updateAllLocales

  //appendnew_flow_updateAllLocales_start
  ...
  //appendnew_flow_updateAllLocales_Catch
}
