...
export class updateLocaleById {
  ...
  private constructor(
    ...
    this.serviceName = 'updateLocaleById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_updateLocaleById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateLocaleById');
    //appendnew_flow_updateLocaleById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateLocaleById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/locale/update-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_updateLocaleById_HttpIn
  }
  //   service flows_updateLocaleById

  //appendnew_flow_updateLocaleById_start
  ...
  //appendnew_flow_updateLocaleById_Catch
}
