...
export class createAllLocale {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllLocale';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_createAllLocale_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllLocale');
    //appendnew_flow_createAllLocale_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllLocale');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/locale/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllLocale_HttpIn
  }
  //   service flows_createAllLocale

  //appendnew_flow_createAllLocale_start
  ...
  //appendnew_flow_createAllLocale_Catch
}
