...
export class findAllApiAudits {
  ...
  private constructor(
    ...
    this.serviceName = 'findAllApiAudits';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findAllApiAudits_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findAllApiAudits');
    //appendnew_flow_findAllApiAudits_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findAllApiAudits');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/api_audit/find-all`,
      cookieParser(),
    ...
    //appendnew_flow_findAllApiAudits_HttpIn
  }
  //   service flows_findAllApiAudits

  //appendnew_flow_findAllApiAudits_start
  ...
  //appendnew_flow_findAllApiAudits_Catch
}
