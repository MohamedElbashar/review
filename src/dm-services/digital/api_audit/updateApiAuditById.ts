...
//append_imports_end
export class updateApiAuditById {
  ...
  private constructor(
    ...
    this.serviceName = 'updateApiAuditById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new updateApiAuditById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_updateApiAuditById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateApiAuditById');
    //appendnew_flow_updateApiAuditById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateApiAuditById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/api_audit/update-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_updateApiAuditById_HttpIn
  }
  //   service flows_updateApiAuditById

  //appendnew_flow_updateApiAuditById_start
  ...
  //appendnew_flow_updateApiAuditById_Catch
}
