...
export class findApiAuditById {
  ...
  private constructor(
    ...
    this.serviceName = 'findApiAuditById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findApiAuditById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findApiAuditById');
    //appendnew_flow_findApiAuditById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findApiAuditById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/api_audit/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findApiAuditById_HttpIn
  }
  //   service flows_findApiAuditById

  //appendnew_flow_findApiAuditById_start
  ...
  //appendnew_flow_findApiAuditById_Catch
}
