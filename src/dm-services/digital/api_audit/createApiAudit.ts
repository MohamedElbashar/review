...
export class createApiAudit {
  ...
  private constructor(
    ...
    this.serviceName = 'createApiAudit';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_createApiAudit_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createApiAudit');
    //appendnew_flow_createApiAudit_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createApiAudit');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/api_audit/create`,
      cookieParser(),
    ...
    //appendnew_flow_createApiAudit_HttpIn
  }
  //   service flows_createApiAudit

  //appendnew_flow_createApiAudit_start
  ...
  //appendnew_flow_createApiAudit_Catch
}
