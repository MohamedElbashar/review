...
export class createDriver {
  ...
  async mountTimers() {
    //appendnew_flow_createDriver_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createDriver');
    //appendnew_flow_createDriver_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createDriver');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/driver/create`,
      cookieParser(),
    ...
    //appendnew_flow_createDriver_HttpIn
  }
  //   service flows_createDriver

  //appendnew_flow_createDriver_start
  ...
  //appendnew_flow_createDriver_Catch
}
