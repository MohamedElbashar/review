...
export class updateDriverById {
  ...
  private constructor(
    ...
    this.serviceName = 'updateDriverById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_updateDriverById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateDriverById');
    //appendnew_flow_updateDriverById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateDriverById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/driver/update-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_updateDriverById_HttpIn
  }
  //   service flows_updateDriverById

  //appendnew_flow_updateDriverById_start
  ...
  //appendnew_flow_updateDriverById_Catch
}
