...
export class findDriverById {
  ...
  private constructor(
    ...
    this.serviceName = 'findDriverById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findDriverById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findDriverById');
    //appendnew_flow_findDriverById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findDriverById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/driver/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findDriverById_HttpIn
  }
  //   service flows_findDriverById

  //appendnew_flow_findDriverById_start
  ...
  //appendnew_flow_findDriverById_Catch
}
