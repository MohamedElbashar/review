...
export class findAllDrivers {
  ...
  private constructor(
    ...
    this.serviceName = 'findAllDrivers';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findAllDrivers_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findAllDrivers');
    //appendnew_flow_findAllDrivers_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findAllDrivers');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/driver/find-all`,
      cookieParser(),
    ...
    //appendnew_flow_findAllDrivers_HttpIn
  }
  //   service flows_findAllDrivers

  //appendnew_flow_findAllDrivers_start
  ...
  //appendnew_flow_findAllDrivers_Catch
}
