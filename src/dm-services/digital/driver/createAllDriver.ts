...
export class createAllDriver {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllDriver';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_createAllDriver_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllDriver');
    //appendnew_flow_createAllDriver_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllDriver');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/driver/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllDriver_HttpIn
  }
  //   service flows_createAllDriver

  //appendnew_flow_createAllDriver_start
  ...
  //appendnew_flow_createAllDriver_Catch
}
