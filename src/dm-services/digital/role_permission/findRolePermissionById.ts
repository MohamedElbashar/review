...
//append_imports_end
export class findRolePermissionById {
  ...
  private constructor(
    ...
    this.serviceName = 'findRolePermissionById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findRolePermissionById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findRolePermissionById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findRolePermissionById');
    //appendnew_flow_findRolePermissionById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findRolePermissionById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/role_permission/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findRolePermissionById_HttpIn
  }
  //   service flows_findRolePermissionById

  //appendnew_flow_findRolePermissionById_start
  ...
  //appendnew_flow_findRolePermissionById_Catch
}
