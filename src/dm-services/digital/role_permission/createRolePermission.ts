...
export class createRolePermission {
  ...
  private constructor(
    ...
    this.serviceName = 'createRolePermission';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createRolePermission(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createRolePermission_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createRolePermission');
    //appendnew_flow_createRolePermission_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createRolePermission');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/role_permission/create`,
      cookieParser(),
    ...
    //appendnew_flow_createRolePermission_HttpIn
  }
  //   service flows_createRolePermission

  //appendnew_flow_createRolePermission_start
  ...
  //appendnew_flow_createRolePermission_Catch
}
