...
//append_imports_end
export class createAllPolicyAudit {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllPolicyAudit';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createAllPolicyAudit(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createAllPolicyAudit_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllPolicyAudit');
    //appendnew_flow_createAllPolicyAudit_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllPolicyAudit');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/policy_audit/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllPolicyAudit_HttpIn
  }
  //   service flows_createAllPolicyAudit

  //appendnew_flow_createAllPolicyAudit_start
  ...
  //appendnew_flow_createAllPolicyAudit_Catch
}
