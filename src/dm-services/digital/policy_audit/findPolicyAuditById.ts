...
//append_imports_end
export class findPolicyAuditById {
  ...
  private constructor(
    ...
    this.serviceName = 'findPolicyAuditById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findPolicyAuditById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findPolicyAuditById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findPolicyAuditById');
    //appendnew_flow_findPolicyAuditById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findPolicyAuditById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/policy_audit/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findPolicyAuditById_HttpIn
  }
  //   service flows_findPolicyAuditById

  //appendnew_flow_findPolicyAuditById_start
  ...
  //appendnew_flow_findPolicyAuditById_Catch
}
