...
//append_imports_end
export class createPolicyAudit {
  ...
  private constructor(
    ...
    this.serviceName = 'createPolicyAudit';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createPolicyAudit(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createPolicyAudit_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createPolicyAudit');
    //appendnew_flow_createPolicyAudit_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createPolicyAudit');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/policy_audit/create`,
      cookieParser(),
    ...
    //appendnew_flow_createPolicyAudit_HttpIn
  }
  //   service flows_createPolicyAudit

  //appendnew_flow_createPolicyAudit_start
  ...
  //appendnew_flow_createPolicyAudit_Catch
}
