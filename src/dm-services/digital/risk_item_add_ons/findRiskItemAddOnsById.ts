...
//append_imports_end
export class findRiskItemAddOnsById {
  ...
  private constructor(
    ...
    this.serviceName = 'findRiskItemAddOnsById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findRiskItemAddOnsById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findRiskItemAddOnsById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findRiskItemAddOnsById');
    //appendnew_flow_findRiskItemAddOnsById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findRiskItemAddOnsById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/risk_item_add_ons/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findRiskItemAddOnsById_HttpIn
  }
  //   service flows_findRiskItemAddOnsById

  //appendnew_flow_findRiskItemAddOnsById_start
  ...
  //appendnew_flow_findRiskItemAddOnsById_Catch
}
