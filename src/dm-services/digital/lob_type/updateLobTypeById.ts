...
//append_imports_end
export class updateLobTypeById {
  ...
  private constructor(
    ...
    this.serviceName = 'updateLobTypeById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new updateLobTypeById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_updateLobTypeById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateLobTypeById');
    //appendnew_flow_updateLobTypeById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateLobTypeById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/lob_type/update-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_updateLobTypeById_HttpIn
  }
  //   service flows_updateLobTypeById

  //appendnew_flow_updateLobTypeById_start
  ...
  //appendnew_flow_updateLobTypeById_Catch
}
