...
export class createAllLobType {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllLobType';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_createAllLobType_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllLobType');
    //appendnew_flow_createAllLobType_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllLobType');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/lob_type/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllLobType_HttpIn
  }
  //   service flows_createAllLobType

  //appendnew_flow_createAllLobType_start
  ...
  //appendnew_flow_createAllLobType_Catch
}
