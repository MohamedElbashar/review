...
export class findAllLobTypes {
  ...
  private constructor(
    ...
    this.serviceName = 'findAllLobTypes';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findAllLobTypes_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findAllLobTypes');
    //appendnew_flow_findAllLobTypes_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findAllLobTypes');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/lob_type/find-all`,
      cookieParser(),
    ...
    //appendnew_flow_findAllLobTypes_HttpIn
  }
  //   service flows_findAllLobTypes

  //appendnew_flow_findAllLobTypes_start
  ...
  //appendnew_flow_findAllLobTypes_Catch
}
