...
export class createLobType {
  ...
  private constructor(
    ...
    this.serviceName = 'createLobType';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_createLobType_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createLobType');
    //appendnew_flow_createLobType_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createLobType');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/lob_type/create`,
      cookieParser(),
    ...
    //appendnew_flow_createLobType_HttpIn
  }
  //   service flows_createLobType

  //appendnew_flow_createLobType_start
  ...
  //appendnew_flow_createLobType_Catch
}
