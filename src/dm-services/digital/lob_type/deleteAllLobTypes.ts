...
//append_imports_end
export class deleteAllLobTypes {
  ...
  private constructor(
    ...
    this.serviceName = 'deleteAllLobTypes';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new deleteAllLobTypes(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_deleteAllLobTypes_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: deleteAllLobTypes');
    //appendnew_flow_deleteAllLobTypes_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: deleteAllLobTypes');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/lob_type/delete-all`,
      cookieParser(),
    ...
    //appendnew_flow_deleteAllLobTypes_HttpIn
  }
  //   service flows_deleteAllLobTypes

  //appendnew_flow_deleteAllLobTypes_start
  ...
  //appendnew_flow_deleteAllLobTypes_Catch
}
