...
export class findLobTypeById {
  ...
  private constructor(
    ...
    this.serviceName = 'findLobTypeById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findLobTypeById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findLobTypeById');
    //appendnew_flow_findLobTypeById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findLobTypeById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/lob_type/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findLobTypeById_HttpIn
  }
  //   service flows_findLobTypeById

  //appendnew_flow_findLobTypeById_start
  ...
  //appendnew_flow_findLobTypeById_Catch
}
