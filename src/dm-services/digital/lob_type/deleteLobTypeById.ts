...
//append_imports_end
export class deleteLobTypeById {
  ...
  private constructor(
    ...
    this.serviceName = 'deleteLobTypeById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new deleteLobTypeById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_deleteLobTypeById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: deleteLobTypeById');
    //appendnew_flow_deleteLobTypeById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: deleteLobTypeById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/lob_type/delete-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_deleteLobTypeById_HttpIn
  }
  //   service flows_deleteLobTypeById

  //appendnew_flow_deleteLobTypeById_start
  ...
  async __operationNode__(bh, parentSpanInst) {
    ...
    try {
      ...
      bh.result = await dmUtilsInst.delete('_EN_m0pi046z1b', bh.filter);
  ...
  //appendnew_flow_deleteLobTypeById_Catch
}
