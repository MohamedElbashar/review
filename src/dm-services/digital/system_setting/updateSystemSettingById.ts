...
//append_imports_end
export class updateSystemSettingById {
  ...
  private constructor(
    ...
    this.serviceName = 'updateSystemSettingById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new updateSystemSettingById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_updateSystemSettingById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug(
      'mounting all middlewares for service :: updateSystemSettingById'
    );
    //appendnew_flow_updateSystemSettingById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateSystemSettingById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/system_setting/update-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_updateSystemSettingById_HttpIn
  }
  //   service flows_updateSystemSettingById

  //appendnew_flow_updateSystemSettingById_start
  ...
  //appendnew_flow_updateSystemSettingById_Catch
}
