...
//append_imports_end
export class deleteSystemSettingById {
  ...
  private constructor(
    ...
    this.serviceName = 'deleteSystemSettingById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new deleteSystemSettingById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_deleteSystemSettingById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug(
      'mounting all middlewares for service :: deleteSystemSettingById'
    );
    //appendnew_flow_deleteSystemSettingById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: deleteSystemSettingById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/system_setting/delete-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_deleteSystemSettingById_HttpIn
  }
  //   service flows_deleteSystemSettingById

  //appendnew_flow_deleteSystemSettingById_start
  ...
  //appendnew_flow_deleteSystemSettingById_Catch
}
