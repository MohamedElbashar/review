...
//append_imports_end
export class updateAllSystemSettings {
  ...
  private constructor(
    ...
    this.serviceName = 'updateAllSystemSettings';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new updateAllSystemSettings(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_updateAllSystemSettings_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug(
      'mounting all middlewares for service :: updateAllSystemSettings'
    );
    //appendnew_flow_updateAllSystemSettings_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateAllSystemSettings');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/system_setting/update-all`,
      cookieParser(),
    ...
    //appendnew_flow_updateAllSystemSettings_HttpIn
  }
  //   service flows_updateAllSystemSettings

  //appendnew_flow_updateAllSystemSettings_start
  ...
  //appendnew_flow_updateAllSystemSettings_Catch
}
