...
//append_imports_end
export class findAllSystemSettings {
  ...
  private constructor(
    ...
    this.serviceName = 'findAllSystemSettings';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findAllSystemSettings(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findAllSystemSettings_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findAllSystemSettings');
    //appendnew_flow_findAllSystemSettings_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findAllSystemSettings');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/system_setting/find-all`,
      cookieParser(),
    ...
    //appendnew_flow_findAllSystemSettings_HttpIn
  }
  //   service flows_findAllSystemSettings

  //appendnew_flow_findAllSystemSettings_start
  ...
  //appendnew_flow_findAllSystemSettings_Catch
}
