...
//append_imports_end
export class findSystemSettingById {
  ...
  private constructor(
    ...
    this.serviceName = 'findSystemSettingById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findSystemSettingById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findSystemSettingById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findSystemSettingById');
    //appendnew_flow_findSystemSettingById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findSystemSettingById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/system_setting/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findSystemSettingById_HttpIn
  }
  //   service flows_findSystemSettingById

  //appendnew_flow_findSystemSettingById_start
  ...
  //appendnew_flow_findSystemSettingById_Catch
}
