...
//append_imports_end
export class createAllSystemSetting {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllSystemSetting';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createAllSystemSetting(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createAllSystemSetting_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllSystemSetting');
    //appendnew_flow_createAllSystemSetting_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllSystemSetting');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/system_setting/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllSystemSetting_HttpIn
  }
  //   service flows_createAllSystemSetting

  //appendnew_flow_createAllSystemSetting_start
  ...
  //appendnew_flow_createAllSystemSetting_Catch
}
