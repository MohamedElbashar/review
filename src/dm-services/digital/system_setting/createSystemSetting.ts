...
//append_imports_end
export class createSystemSetting {
  ...
  private constructor(
    ...
    this.serviceName = 'createSystemSetting';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createSystemSetting(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createSystemSetting_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createSystemSetting');
    //appendnew_flow_createSystemSetting_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createSystemSetting');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/system_setting/create`,
      cookieParser(),
    ...
    //appendnew_flow_createSystemSetting_HttpIn
  }
  //   service flows_createSystemSetting

  //appendnew_flow_createSystemSetting_start
  ...
  //appendnew_flow_createSystemSetting_Catch
}
