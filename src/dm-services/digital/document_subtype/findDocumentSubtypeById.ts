...
//append_imports_end
export class findDocumentSubtypeById {
  ...
  private constructor(
    ...
    this.serviceName = 'findDocumentSubtypeById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findDocumentSubtypeById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findDocumentSubtypeById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug(
      'mounting all middlewares for service :: findDocumentSubtypeById'
    );
    //appendnew_flow_findDocumentSubtypeById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findDocumentSubtypeById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/document_subtype/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findDocumentSubtypeById_HttpIn
  }
  //   service flows_findDocumentSubtypeById

  //appendnew_flow_findDocumentSubtypeById_start
  ...
  //appendnew_flow_findDocumentSubtypeById_Catch
}
