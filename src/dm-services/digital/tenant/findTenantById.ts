...
export class findTenantById {
  ...
  private constructor(
    ...
    this.serviceName = 'findTenantById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findTenantById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findTenantById');
    //appendnew_flow_findTenantById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findTenantById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/tenant/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findTenantById_HttpIn
  }
  //   service flows_findTenantById

  //appendnew_flow_findTenantById_start
  ...
  //appendnew_flow_findTenantById_Catch
}
