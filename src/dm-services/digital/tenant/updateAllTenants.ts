...
export class updateAllTenants {
  ...
  private constructor(
    ...
    this.serviceName = 'updateAllTenants';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_updateAllTenants_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateAllTenants');
    //appendnew_flow_updateAllTenants_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateAllTenants');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/tenant/update-all`,
      cookieParser(),
    ...
    //appendnew_flow_updateAllTenants_HttpIn
  }
  //   service flows_updateAllTenants

  //appendnew_flow_updateAllTenants_start
  ...
  //appendnew_flow_updateAllTenants_Catch
}
