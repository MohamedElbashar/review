...
export class deleteAllTenants {
  ...
  private constructor(
    ...
    this.serviceName = 'deleteAllTenants';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_deleteAllTenants_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: deleteAllTenants');
    //appendnew_flow_deleteAllTenants_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: deleteAllTenants');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/tenant/delete-all`,
      cookieParser(),
    ...
    //appendnew_flow_deleteAllTenants_HttpIn
  }
  //   service flows_deleteAllTenants

  //appendnew_flow_deleteAllTenants_start
  ...
  //appendnew_flow_deleteAllTenants_Catch
}
