...
export class findAllTenants {
  ...
  private constructor(
    ...
    this.serviceName = 'findAllTenants';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findAllTenants_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findAllTenants');
    //appendnew_flow_findAllTenants_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findAllTenants');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/tenant/find-all`,
      cookieParser(),
    ...
    //appendnew_flow_findAllTenants_HttpIn
  }
  //   service flows_findAllTenants

  //appendnew_flow_findAllTenants_start
  ...
  //appendnew_flow_findAllTenants_Catch
}
