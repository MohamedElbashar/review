...
export class createTenant {
  ...
  async mountTimers() {
    //appendnew_flow_createTenant_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createTenant');
    //appendnew_flow_createTenant_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createTenant');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/tenant/create`,
      cookieParser(),
    ...
    //appendnew_flow_createTenant_HttpIn
  }
  //   service flows_createTenant

  //appendnew_flow_createTenant_start
  ...
  //appendnew_flow_createTenant_Catch
}
