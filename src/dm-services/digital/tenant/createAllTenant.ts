...
export class createAllTenant {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllTenant';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_createAllTenant_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllTenant');
    //appendnew_flow_createAllTenant_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllTenant');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/tenant/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllTenant_HttpIn
  }
  //   service flows_createAllTenant

  //appendnew_flow_createAllTenant_start
  ...
  //appendnew_flow_createAllTenant_Catch
}
