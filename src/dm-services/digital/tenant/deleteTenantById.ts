...
export class deleteTenantById {
  ...
  private constructor(
    ...
    this.serviceName = 'deleteTenantById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_deleteTenantById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: deleteTenantById');
    //appendnew_flow_deleteTenantById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: deleteTenantById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/tenant/delete-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_deleteTenantById_HttpIn
  }
  //   service flows_deleteTenantById

  //appendnew_flow_deleteTenantById_start
  ...
  async __operationNode__(bh, parentSpanInst) {
    ...
    try {
      ...
      bh.result = await dmUtilsInst.delete('_EN_811h013adx', bh.filter);
  ...
  //appendnew_flow_deleteTenantById_Catch
}
