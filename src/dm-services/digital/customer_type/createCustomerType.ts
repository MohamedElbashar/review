...
export class createCustomerType {
  ...
  private constructor(
    ...
    this.serviceName = 'createCustomerType';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createCustomerType(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createCustomerType_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createCustomerType');
    //appendnew_flow_createCustomerType_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createCustomerType');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/customer_type/create`,
      cookieParser(),
    ...
    //appendnew_flow_createCustomerType_HttpIn
  }
  //   service flows_createCustomerType
  ...
  //appendnew_flow_createCustomerType_Catch
}
