...
//append_imports_end
export class findCustomerTypeById {
  ...
  private constructor(
    ...
    this.serviceName = 'findCustomerTypeById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findCustomerTypeById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findCustomerTypeById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findCustomerTypeById');
    //appendnew_flow_findCustomerTypeById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findCustomerTypeById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/customer_type/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findCustomerTypeById_HttpIn
  }
  //   service flows_findCustomerTypeById

  //appendnew_flow_findCustomerTypeById_start
  ...
  //appendnew_flow_findCustomerTypeById_Catch
}
