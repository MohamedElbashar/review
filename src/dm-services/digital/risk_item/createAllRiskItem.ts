...
//append_imports_end
export class createAllRiskItem {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllRiskItem';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createAllRiskItem(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createAllRiskItem_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllRiskItem');
    //appendnew_flow_createAllRiskItem_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllRiskItem');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/risk_item/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllRiskItem_HttpIn
  }
  //   service flows_createAllRiskItem

  //appendnew_flow_createAllRiskItem_start
  ...
  //appendnew_flow_createAllRiskItem_Catch
}
