...
export class createRiskItem {
  ...
  private constructor(
    ...
    this.serviceName = 'createRiskItem';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_createRiskItem_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createRiskItem');
    //appendnew_flow_createRiskItem_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createRiskItem');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/risk_item/create`,
      cookieParser(),
    ...
    //appendnew_flow_createRiskItem_HttpIn
  }
  //   service flows_createRiskItem

  //appendnew_flow_createRiskItem_start
  ...
  //appendnew_flow_createRiskItem_Catch
}
