...
export class findRiskItemById {
  ...
  private constructor(
    ...
    this.serviceName = 'findRiskItemById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findRiskItemById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findRiskItemById');
    //appendnew_flow_findRiskItemById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findRiskItemById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/risk_item/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findRiskItemById_HttpIn
  }
  //   service flows_findRiskItemById

  //appendnew_flow_findRiskItemById_start
  ...
  //appendnew_flow_findRiskItemById_Catch
}
