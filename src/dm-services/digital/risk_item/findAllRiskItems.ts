...
export class findAllRiskItems {
  ...
  private constructor(
    ...
    this.serviceName = 'findAllRiskItems';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findAllRiskItems_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findAllRiskItems');
    //appendnew_flow_findAllRiskItems_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findAllRiskItems');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/risk_item/find-all`,
      cookieParser(),
    ...
    //appendnew_flow_findAllRiskItems_HttpIn
  }
  //   service flows_findAllRiskItems

  //appendnew_flow_findAllRiskItems_start
  ...
  //appendnew_flow_findAllRiskItems_Catch
}
