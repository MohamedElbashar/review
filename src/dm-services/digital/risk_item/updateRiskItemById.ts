...
//append_imports_end
export class updateRiskItemById {
  ...
  private constructor(
    ...
    this.serviceName = 'updateRiskItemById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new updateRiskItemById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_updateRiskItemById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateRiskItemById');
    //appendnew_flow_updateRiskItemById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateRiskItemById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/risk_item/update-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_updateRiskItemById_HttpIn
  }
  //   service flows_updateRiskItemById

  //appendnew_flow_updateRiskItemById_start
  ...
  //appendnew_flow_updateRiskItemById_Catch
}
