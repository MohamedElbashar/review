...
//append_imports_end
export class updateAllRiskItems {
  ...
  private constructor(
    ...
    this.serviceName = 'updateAllRiskItems';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new updateAllRiskItems(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_updateAllRiskItems_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateAllRiskItems');
    //appendnew_flow_updateAllRiskItems_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateAllRiskItems');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/risk_item/update-all`,
      cookieParser(),
    ...
    //appendnew_flow_updateAllRiskItems_HttpIn
  }
  //   service flows_updateAllRiskItems

  //appendnew_flow_updateAllRiskItems_start
  ...
  //appendnew_flow_updateAllRiskItems_Catch
}
