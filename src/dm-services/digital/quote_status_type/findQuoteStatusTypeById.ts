...
//append_imports_end
export class findQuoteStatusTypeById {
  ...
  private constructor(
    ...
    this.serviceName = 'findQuoteStatusTypeById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findQuoteStatusTypeById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findQuoteStatusTypeById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug(
      'mounting all middlewares for service :: findQuoteStatusTypeById'
    );
    //appendnew_flow_findQuoteStatusTypeById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findQuoteStatusTypeById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/quote_status_type/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findQuoteStatusTypeById_HttpIn
  }
  //   service flows_findQuoteStatusTypeById

  //appendnew_flow_findQuoteStatusTypeById_start
  ...
  //appendnew_flow_findQuoteStatusTypeById_Catch
}
