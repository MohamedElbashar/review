...
//append_imports_end
export class findDocumentTypeById {
  ...
  private constructor(
    ...
    this.serviceName = 'findDocumentTypeById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findDocumentTypeById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findDocumentTypeById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findDocumentTypeById');
    //appendnew_flow_findDocumentTypeById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findDocumentTypeById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/document_type/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findDocumentTypeById_HttpIn
  }
  //   service flows_findDocumentTypeById

  //appendnew_flow_findDocumentTypeById_start
  ...
  //appendnew_flow_findDocumentTypeById_Catch
}
