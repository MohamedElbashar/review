...
export class createDocumentType {
  ...
  private constructor(
    ...
    this.serviceName = 'createDocumentType';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createDocumentType(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createDocumentType_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createDocumentType');
    //appendnew_flow_createDocumentType_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createDocumentType');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/document_type/create`,
      cookieParser(),
    ...
    //appendnew_flow_createDocumentType_HttpIn
  }
  //   service flows_createDocumentType

  //appendnew_flow_createDocumentType_start
  ...
  //appendnew_flow_createDocumentType_Catch
}
