...
export class createPermission {
  ...
  private constructor(
    ...
    this.serviceName = 'createPermission';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_createPermission_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createPermission');
    //appendnew_flow_createPermission_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createPermission');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/permission/create`,
      cookieParser(),
    ...
    //appendnew_flow_createPermission_HttpIn
  }
  //   service flows_createPermission

  //appendnew_flow_createPermission_start
  ...
  //appendnew_flow_createPermission_Catch
}
