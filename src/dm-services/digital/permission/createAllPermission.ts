...
//append_imports_end
export class createAllPermission {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllPermission';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createAllPermission(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createAllPermission_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllPermission');
    //appendnew_flow_createAllPermission_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllPermission');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/permission/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllPermission_HttpIn
  }
  //   service flows_createAllPermission

  //appendnew_flow_createAllPermission_start
  ...
  //appendnew_flow_createAllPermission_Catch
}
