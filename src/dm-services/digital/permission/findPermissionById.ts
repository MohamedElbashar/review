...
//append_imports_end
export class findPermissionById {
  ...
  private constructor(
    ...
    this.serviceName = 'findPermissionById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findPermissionById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findPermissionById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findPermissionById');
    //appendnew_flow_findPermissionById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findPermissionById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/permission/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findPermissionById_HttpIn
  }
  //   service flows_findPermissionById

  //appendnew_flow_findPermissionById_start
  ...
  //appendnew_flow_findPermissionById_Catch
}
