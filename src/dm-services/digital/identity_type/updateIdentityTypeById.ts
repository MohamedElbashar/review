...
//append_imports_end
export class updateIdentityTypeById {
  ...
  private constructor(
    ...
    this.serviceName = 'updateIdentityTypeById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new updateIdentityTypeById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_updateIdentityTypeById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateIdentityTypeById');
    //appendnew_flow_updateIdentityTypeById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateIdentityTypeById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/identity_type/update-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_updateIdentityTypeById_HttpIn
  }
  //   service flows_updateIdentityTypeById

  //appendnew_flow_updateIdentityTypeById_start
  ...
  //appendnew_flow_updateIdentityTypeById_Catch
}
