...
//append_imports_end
export class findAllIdentityTypes {
  ...
  private constructor(
    ...
    this.serviceName = 'findAllIdentityTypes';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findAllIdentityTypes(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findAllIdentityTypes_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findAllIdentityTypes');
    //appendnew_flow_findAllIdentityTypes_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findAllIdentityTypes');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/identity_type/find-all`,
      cookieParser(),
    ...
    //appendnew_flow_findAllIdentityTypes_HttpIn
  }
  //   service flows_findAllIdentityTypes

  //appendnew_flow_findAllIdentityTypes_start
  ...
  //appendnew_flow_findAllIdentityTypes_Catch
}
