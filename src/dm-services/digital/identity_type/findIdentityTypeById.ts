...
//append_imports_end
export class findIdentityTypeById {
  ...
  private constructor(
    ...
    this.serviceName = 'findIdentityTypeById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findIdentityTypeById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findIdentityTypeById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findIdentityTypeById');
    //appendnew_flow_findIdentityTypeById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findIdentityTypeById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/identity_type/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findIdentityTypeById_HttpIn
  }
  //   service flows_findIdentityTypeById

  //appendnew_flow_findIdentityTypeById_start
  ...
  //appendnew_flow_findIdentityTypeById_Catch
}
