...
//append_imports_end
export class createAllIdentityType {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllIdentityType';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createAllIdentityType(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createAllIdentityType_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllIdentityType');
    //appendnew_flow_createAllIdentityType_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllIdentityType');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/identity_type/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllIdentityType_HttpIn
  }
  //   service flows_createAllIdentityType

  //appendnew_flow_createAllIdentityType_start
  ...
  //appendnew_flow_createAllIdentityType_Catch
}
