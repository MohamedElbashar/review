...
//append_imports_end
export class updateAllIdentityTypes {
  ...
  private constructor(
    ...
    this.serviceName = 'updateAllIdentityTypes';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new updateAllIdentityTypes(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_updateAllIdentityTypes_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateAllIdentityTypes');
    //appendnew_flow_updateAllIdentityTypes_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateAllIdentityTypes');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/identity_type/update-all`,
      cookieParser(),
    ...
    //appendnew_flow_updateAllIdentityTypes_HttpIn
  }
  //   service flows_updateAllIdentityTypes

  //appendnew_flow_updateAllIdentityTypes_start
  ...
  //appendnew_flow_updateAllIdentityTypes_Catch
}
