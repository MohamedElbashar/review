...
//append_imports_end
export class createFileMetadata {
  ...
  private constructor(
    ...
    this.serviceName = 'createFileMetadata';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new createFileMetadata(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_createFileMetadata_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createFileMetadata');
    //appendnew_flow_createFileMetadata_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createFileMetadata');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/file_metadata/create`,
      cookieParser(),
    ...
    //appendnew_flow_createFileMetadata_HttpIn
  }
  //   service flows_createFileMetadata

  //appendnew_flow_createFileMetadata_start
  ...
  //appendnew_flow_createFileMetadata_Catch
}
