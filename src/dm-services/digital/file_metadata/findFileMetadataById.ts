...
//append_imports_end
export class findFileMetadataById {
  ...
  private constructor(
    ...
    this.serviceName = 'findFileMetadataById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findFileMetadataById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findFileMetadataById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findFileMetadataById');
    //appendnew_flow_findFileMetadataById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findFileMetadataById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/file_metadata/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findFileMetadataById_HttpIn
  }
  //   service flows_findFileMetadataById

  //appendnew_flow_findFileMetadataById_start
  ...
  //appendnew_flow_findFileMetadataById_Catch
}
