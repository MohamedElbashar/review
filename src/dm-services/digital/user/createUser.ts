...
export class createUser {
  ...
  async mountTimers() {
    //appendnew_flow_createUser_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createUser');
    //appendnew_flow_createUser_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createUser');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/user/create`,
      cookieParser(),
    ...
    //appendnew_flow_createUser_HttpIn
  }
  //   service flows_createUser

  //appendnew_flow_createUser_start
  ...
  //appendnew_flow_createUser_Catch
}
