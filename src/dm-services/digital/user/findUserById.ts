...
export class findUserById {
  ...
  async mountTimers() {
    //appendnew_flow_findUserById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findUserById');
    //appendnew_flow_findUserById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findUserById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/user/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findUserById_HttpIn
  }
  //   service flows_findUserById

  //appendnew_flow_findUserById_start
  ...
  //appendnew_flow_findUserById_Catch
}
