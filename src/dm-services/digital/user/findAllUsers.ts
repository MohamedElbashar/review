...
export class findAllUsers {
  ...
  async mountTimers() {
    //appendnew_flow_findAllUsers_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findAllUsers');
    //appendnew_flow_findAllUsers_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findAllUsers');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/user/find-all`,
      cookieParser(),
    ...
    //appendnew_flow_findAllUsers_HttpIn
  }
  //   service flows_findAllUsers

  //appendnew_flow_findAllUsers_start
  ...
  //appendnew_flow_findAllUsers_Catch
}
