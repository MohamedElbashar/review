...
export class createAllUser {
  ...
  private constructor(
    ...
    this.serviceName = 'createAllUser';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_createAllUser_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: createAllUser');
    //appendnew_flow_createAllUser_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: createAllUser');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/user/create-all`,
      cookieParser(),
    ...
    //appendnew_flow_createAllUser_HttpIn
  }
  //   service flows_createAllUser

  //appendnew_flow_createAllUser_start
  ...
  //appendnew_flow_createAllUser_Catch
}
