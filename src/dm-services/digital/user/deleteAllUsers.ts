...
export class deleteAllUsers {
  ...
  private constructor(
    ...
    this.serviceName = 'deleteAllUsers';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_deleteAllUsers_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: deleteAllUsers');
    //appendnew_flow_deleteAllUsers_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: deleteAllUsers');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/user/delete-all`,
      cookieParser(),
    ...
    //appendnew_flow_deleteAllUsers_HttpIn
  }
  //   service flows_deleteAllUsers

  //appendnew_flow_deleteAllUsers_start
  ...
  //appendnew_flow_deleteAllUsers_Catch
}
