...
export class updateUserById {
  ...
  private constructor(
    ...
    this.serviceName = 'updateUserById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_updateUserById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateUserById');
    //appendnew_flow_updateUserById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateUserById');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/user/update-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_updateUserById_HttpIn
  }
  //   service flows_updateUserById

  //appendnew_flow_updateUserById_start
  ...
  //appendnew_flow_updateUserById_Catch
}
