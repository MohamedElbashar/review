...
export class updateAllUsers {
  ...
  private constructor(
    ...
    this.serviceName = 'updateAllUsers';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_updateAllUsers_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: updateAllUsers');
    //appendnew_flow_updateAllUsers_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: updateAllUsers');

    this.app['post'](
      `${this.serviceBasePath}/dm/digital/user/update-all`,
      cookieParser(),
    ...
    //appendnew_flow_updateAllUsers_HttpIn
  }
  //   service flows_updateAllUsers

  //appendnew_flow_updateAllUsers_start
  ...
  //appendnew_flow_updateAllUsers_Catch
}
