...
//append_imports_end
export class findSystemMessagesById {
  ...
  private constructor(
    ...
    this.serviceName = 'findSystemMessagesById';
    this.app = app;
  ...
  static getInstance(
    ...
    if (!instance) {
      instance = new findSystemMessagesById(
        app,
        generatedeMiddlewares,
        routeCall,
        middlewareCall,
  ...
  async mountTimers() {
    //appendnew_flow_findSystemMessagesById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findSystemMessagesById');
    //appendnew_flow_findSystemMessagesById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findSystemMessagesById');

    this.app['post'](
      `${this.serviceBasePath}/dm/payments/system_messages/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findSystemMessagesById_HttpIn
  }
  //   service flows_findSystemMessagesById

  //appendnew_flow_findSystemMessagesById_start
  ...
  //appendnew_flow_findSystemMessagesById_Catch
}
