...
export class findLocaleById {
  ...
  private constructor(
    ...
    this.serviceName = 'findLocaleById';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findLocaleById_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findLocaleById');
    //appendnew_flow_findLocaleById_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findLocaleById');

    this.app['post'](
      `${this.serviceBasePath}/dm/payments/locale/find-by-id`,
      cookieParser(),
    ...
    //appendnew_flow_findLocaleById_HttpIn
  }
  //   service flows_findLocaleById

  //appendnew_flow_findLocaleById_start
  ...
  //appendnew_flow_findLocaleById_Catch
}
