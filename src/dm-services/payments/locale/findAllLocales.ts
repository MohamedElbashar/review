...
export class findAllLocales {
  ...
  private constructor(
    ...
    this.serviceName = 'findAllLocales';
    this.app = app;
  ...
  async mountTimers() {
    //appendnew_flow_findAllLocales_TimerStart
  }

  private mountAllMiddlewares() {
    log.debug('mounting all middlewares for service :: findAllLocales');
    //appendnew_flow_findAllLocales_MiddlewareStart
  }

  private mountAllPaths() {
    log.debug('mounting all paths for service :: findAllLocales');

    this.app['post'](
      `${this.serviceBasePath}/dm/payments/locale/find-all`,
      cookieParser(),
    ...
    //appendnew_flow_findAllLocales_HttpIn
  }
  //   service flows_findAllLocales

  //appendnew_flow_findAllLocales_start
  ...
  //appendnew_flow_findAllLocales_Catch
}
